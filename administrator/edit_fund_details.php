...
<h2 align="center"><b>Modify the Funds Using Transaction ID</b></h2>
	<form action = "" method = "POST" autocomplete = "on">
    	...
    	<table id="table1"; cellspacing="5px" cellpadding="5%"; align="center">
			...
			<tr>
              <td align="right">Transacion ID : </td>
              <td><input type="text" name="transaction_id" maxlength="15" autocomplete = "on"
              required = "required" autofocus = "autofocus" placeholder="Enter the transaction ID"></td>
       		</tr>

       		<tr>
              <td align="right">Email ID : </td>
              <td><input type="text" name="email_id" maxlength="30" autocomplete = "on" required = "required" placeholder="Enter the Email ID"></td>
       </tr>
       ...
       <tr>
        ...
        <tr>
        <td align="right"> <input type="submit" value="Modify Funds Amount" align="center"/></td>
...
//get the current fund amount based on transaction ID
    $current_fund_query = "SELECT amount FROM account_summary WHERE transaction_id = '$transaction_id'";
    $current_fund_amount = mysqli_query($db, $current_fund_query);
    $temp = mysqli_fetch_assoc($current_fund_amount);
    $temp_fund_amount_modify = $temp["amount"];
...
//get the current fund amount
    ...
    $current_fund_amount = mysqli_query($db, $current_fund_query);
    $temp = mysqli_fetch_assoc($current_fund_amount);
    $temp_current_fund_amount = $temp["current_fund_amount"] - $temp_fund_amount_modify ;

//update the fund amount into database

    $update_fund_query = "UPDATE `account_summary` SET `transaction_id`= '$transaction_id' ,`email_id`= '$email_id', `first_name`= '$first_name',`last_name`= '$last_name',`amount` = '$fund_amount',`day`= '$day', `month` = '$month', `year`= '$year',`time1`= '$time1' WHERE transaction_id = '$transaction_id';";
