...
<body >
  ...
  <div id="body">
    ...
    <h2 align="center"><b> Expendicture Entry</b></h2>
...
//insert the fund amount into database
    $add_fund_query = "INSERT INTO `expendicture_entry` (`day`, `month`, `year`, `time1`, `description`, `amount_spend`, `spend_to_shop`, `current_fund_before`, `current_fund_after`) VALUES ('$day', '$month', '$year', '$time1', '$description', '$amount_spend', '$spend_to_shop', '$current_fund_before', '$current_fund_after');";

    $result = mysqli_query($db, $add_fund_query);
    if($result == 1){
    print "Expendicture details added successfully";
    }
    else
    {
    print "Expendicture details not added Error!!!";
    }
